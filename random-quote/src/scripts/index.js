...
document.getElementById("reload").addEventListener('click', () => {
  const randomQuote = choice(quotes);
  document.getElementById('quote_content').textContent = randomQuote.quoteText;
  document.getElementById('quote_author').textContent = randomQuote.quoteAuthor ? randomQuote.quoteAuthor : 'Unknown';
});